...
enum CompilerOps {
    ...
    static let postsWithoutConnectionQuery =
        pageInfoFragment + "\n" + postFragment + """
    ...
    static let postsWithDefaultsQuery =
        pageInfoFragment + "\n" + postFragment + """
    ...
    static let postsWithAggregationsQuery =
        pageInfoFragment + "\n" + postFragment + "\n" + tagFragment + "\n" + mediaFragment + "\n" + statFragment + """
    ...
    static let userPostsCommentsQuery =
        pageInfoFragment + "\n" + userFragment + "\n" + postFragment + "\n" + commentFragment + """
    ...
    static let usersPostsCommentsQuery =
        pageInfoFragment + "\n" + userFragment + "\n" + postFragment + "\n" + commentFragment + """
    ...
    static let userPostsWithKeyFragment =
        pageInfoFragment + "\n" + userFragment + "\n" + postFragment + """
    ...
    static let postCommentsFragment =
        pageInfoFragment + """
    ...
    static let userUpdatedSubscription =
        userFragment + """
