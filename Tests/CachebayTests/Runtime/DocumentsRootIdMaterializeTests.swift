...
final class DocumentsRootIdMaterializeTests: XCTestCase {
    ...
    func test_materialize_multiple_mutations_independently() throws {
        ...
        documents.normalize(plan: p, variables: vars1, data: .object([
            "updateUser": .object([
                "__typename": "UpdateUserPayload",
        ...
        documents.normalize(plan: p, variables: vars2, data: .object([
            "updateUser": .object([
                "__typename": "UpdateUserPayload",
    ...
    func test_materialize_mutation_with_wrong_variables_misses() throws {
        ...
        documents.normalize(plan: p, variables: correct, data: .object([
            "updateUser": .object([
                "__typename": "UpdateUserPayload",
    ...
    func test_fragment_read_with_standard_id_field() throws {
        ...
        documents.normalize(plan: queryPlan, variables: ["id": "u1"], data: .object([
    ...
    func test_fragment_read_with_custom_key_uuid_and_nested_ref() throws {
        ...
        documents.normalize(plan: userPlan, variables: ["id": "u1"], data: .object([
        ...
        """)
        documents.normalize(plan: commentQuery, variables: ["uuid": .string(commentUuid)], data: .object([
            "comment": .object([
                "__typename": "Comment",
        ...
        let fragPlan = try Compiler.compilePlan(source: """
    ...
    func test_fragment_with_nested_entity_array_resolves_correctly() throws {
        ...
        """)
        documents.normalize(plan: userQuery, variables: ["id": "u1"], data: .object([
            "user": .object([
                "__typename": "User",
                "id": "u1",
                "name": "Alice",
