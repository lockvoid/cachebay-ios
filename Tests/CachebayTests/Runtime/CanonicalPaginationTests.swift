...
final class CanonicalPaginationTests: XCTestCase {
    ...
    func test_forward_refetchSamePage_dedupAgainstKept() throws {
        ...
        XCTAssertEqual(
            canonicalNodeIds(graph, canonicalKey), ["p1", "p2", "p3", "p4", "p5", "p6"],
    ...
    func test_forward_preservesExistingExtras() throws {
        ...
        XCTAssertEqual(
            graph.getField(canonicalKey, "totalCount")?.int, 100,
    ...
    func test_forward_updatesExtrasWhenIncomingProvidesNew() throws {
        ...
        XCTAssertEqual(
            graph.getField(canonicalKey, "totalCount")?.int, 105,
    ...
    func test_forward_missingCursor_appendsAtEnd() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["first": 3, "after": "p99"],
            data: buildPosts(
                ids: ["p4", "p5", "p6"], endCursor: "p6", hasNext: false
            ))
    ...
    func test_backward_pageInfo_startBoundaryUpdated() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["last": 3, "before": "p4"],
            data: buildPosts(
                ids: ["p1", "p2", "p3"], startCursor: "p1", endCursor: "p3", hasPrev: false, hasNext: true
            ))
    ...
    func test_backward_missingCursor_prependsAtStart() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["last": 3, "before": "p99"],
            data: buildPosts(
    ...
    func test_backward_multiplePagesInSequence() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["first": 2],
            data: buildPosts(
                ids: ["p5", "p6"], startCursor: "p5", endCursor: "p6", hasPrev: true
            ))
        docs.normalize(
            plan: plan, variables: ["last": 2, "before": "p5"],
            data: buildPosts(
        ...
        docs.normalize(
            plan: plan, variables: ["last": 2, "before": "p3"],
            data: buildPosts(
    ...
    func test_splice_refetchSameLeaderPage_replaces() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["first": 4],
            data: buildPosts(
                ids: ["p1", "p2", "p3", "p4"], endCursor: "p4", hasNext: true
            ))
        docs.normalize(
            plan: plan, variables: ["first": 4, "after": "p4"],
            data: buildPosts(
        ...
        XCTAssertEqual(
            canonicalNodeIds(graph, canonicalKey), ["p1", "p2", "p3", "p4"],
    ...
    func test_filters_separateCanonicalKeys() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["role": "admin", "first": 2],
            data: buildUsers(
                ids: ["u1", "u2"], startCursor: "u1", endCursor: "u2", hasNext: false
            ))
        docs.normalize(
            plan: plan, variables: ["role": "user", "first": 2],
            data: buildUsers(
    ...
    func test_filters_paginateIndependently() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["role": "admin", "first": 2, "after": "a2"],
            data: buildUsers(
    ...
    func test_forward_refetchMiddlePage_discardsFuturePages() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["first": 3, "after": "p6"],
            data: buildPosts(
                ids: ["p7", "p8", "p9"], startCursor: "p7", endCursor: "p9", hasNext: false
            ))
        XCTAssertEqual(
            canonicalNodeIds(graph, canonicalKey),
    ...
    func test_backward_refetchMiddlePage_discardsEarlierPages() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["last": 3, "before": "p7"],
            data: buildPosts(
                ids: ["p4", "p5", "p6"], startCursor: "p4", endCursor: "p6", hasPrev: true, hasNext: true
            ))
        XCTAssertEqual(
    ...
    func test_filters_leaderRefetch_isolated() throws {
        ...
        docs.normalize(
            plan: plan, variables: ["role": "admin", "first": 2, "after": "u2"],
            data: buildUsers(
                ids: ["u3", "u4"], startCursor: "u3", endCursor: "u4", hasNext: false
            ))
